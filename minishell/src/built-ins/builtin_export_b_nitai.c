...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   builtin_export_b_nitai.c                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: alsima <alsima@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/03 03:07:51 by alsima            #+#    #+#             */
/*   Updated: 2025/09/03 03:08:30 by alsima           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	builtin_export_b(t_cmd_set *p, char **args)
{
	...
	while (args[++i])
	{
		if (args[i][0] == '-' && ft_strcmp(args[i], "--") != 0
			&& ft_strcmp(args[i], "-n") != 0 && ft_strcmp(args[i], "-f") != 0)
		{
		...
		if (equals && equals > args[i] && *(equals - 1) == '+')
		{
			var_name = ft_substr(args[i], 0, equals - args[i] - 1);
